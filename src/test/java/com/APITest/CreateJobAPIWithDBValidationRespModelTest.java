...
public class CreateJobAPIWithDBValidationRespModelTest {
	...
	public void setUp() {
		...
		customerproduct=new FDCustomerProduct(DateTimeUtil.getTimeWithDaysAgo(01), "527568497792798", "527568497792798", "527568497792798", DateTimeUtil.getTimeWithDaysAgo(01), Product.NEXUS_2.getCode(), MstModelId.Nexus_2blue.getMstModelId());
