...
public class FDCustomerProduct {
	private String dop;
	 ...
	 * @param mst_model_id
	 */
	public FDCustomerProduct(String dop, String serial_number, String imei1, String imei2, String popurl,
	...
	public String toString() {
		return "FDCustomerProduct [dop=" + dop + ", serial_number=" + serial_number + ", imei1=" + imei1 + ", imei2="
